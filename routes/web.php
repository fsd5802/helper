...
Route::group(['prefix' => '{locale}', 'middleware' => 'SwitchLanguage'], function () {
    ...
    Route::get('/jobs', [App\Http\Controllers\user\HomeController::class, 'jobs'])->name("jobs");
    Route::get('/services/{id}', [App\Http\Controllers\user\HomeController::class, 'single_service'])->name("single_service");
    Route::get('/jobs/{id}', [App\Http\Controllers\user\HomeController::class, 'single_job'])->name("single_job");
