               ...
               --}}
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{getRoute('service-requests.index')}}" class="menu-link">
                        ...
                        <span class="menu-text">{{ trans('general.aside.service_requests') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                ...
                <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                    <a href="{{getRoute('quotations.index')}}" class="menu-link">
                        ...
                        <span class="menu-text">{{ trans('general.aside.quotation_requests') }}</span>
                        <i class="menu-arrow"></i>
                    </a>

                </li>
                {{-- end quotation requests  section --}}
