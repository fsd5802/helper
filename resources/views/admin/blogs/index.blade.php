...
@section('module_name') @lang('admin.header.blogs') @endsection
@section('title') @lang('admin.header.blogs') @endsection
@section('create_route') {{ getRoute('blogs.create') }} @endsection
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', [ 'name'=>'blogs', 'value'=>$value])
                    </td>
