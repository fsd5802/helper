...
@section('module_name') @lang('admin.header.services') @endsection
@section('title') @lang('admin.header.services') @endsection
@section('create_route') {{ getRoute('services.create') }} @endsection
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', [ 'name'=>'services', 'value'=>$value])
                    </td>
