...
@section('module_name') @lang('admin.header.jobs') @endsection
@section('title') @lang('admin.header.jobs') @endsection
@section('create_route') {{ getRoute('jobs.create') }} @endsection
        ...
        <tbody>
            @foreach ($data as $key => $value)
                <tr>
                    ...
                    <td>
                        @include('admin.components.table-control', [ 'name'=>'jobs', 'value'=>$value])
                    </td>
