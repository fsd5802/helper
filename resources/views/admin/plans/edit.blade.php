    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
                    ...
                    <div class="tab-pane fade show @if ($key == 0) active @endif" id="{{ $locale }}" role="tabpanel">
                        ...
                        <div class="col form-group">
                            <label>@lang('admin.general.supportedplans') (@lang('general.'.$locale))<span
                                    class="text-danger">*</span></label>
                            <textarea name="{{ $locale . '[checkeddec]' }}"
                                      placeholder="@lang('admin.general.supportedplans')"
                                      class="form-control @error(" $locale.checkeddec") is-invalid @enderror"
                                      id="{{ $locale }}.editor1">
                    {{ old($locale . '.checkeddec', strip_tags($plan->translate($locale)->checkeddec)) }}
                </textarea>
                            <script>
                        ...
                        <div class="col form-group">
                            ...
                            <textarea name="{{ $locale . '[uncheckeddec]' }}"
                                      placeholder="@lang('admin.general.unsupportedplans')"
                                      class="form-control @error(" $locale.uncheckeddec") is-invalid @enderror"
                                      id="{{ $locale }}.editor2">
                    {{ old($locale . '.uncheckeddec', strip_tags($plan->translate($locale)->uncheckeddec)) }}
                </textarea>
                            <script>
            ...
            <div class="col form-group">
                ...
                <input type="number" min="0" value="{{ old("price",$plan->price) }}" name="price" placeholder="@lang('admin.general.price')"
