            ...
            <div class="tab-content">
                ...
                @foreach (config('translatable.locales') as $key => $locale)
                    ...
                    <div class="col form-group">
                        ...
                        class="form-control @error(" $locale.checkeddec") is-invalid @enderror"  id="{{ $locale }}.editor1">
                ...
                <div class="col form-group">
                        <label>@lang('admin.general.unsupportedplans') (@lang('general.'.$locale))<span
                                class="text-danger">*</span></label>
                        <textarea name="{{ $locale . '[uncheckeddec]' }}" placeholder="@lang('admin.general.unsupportedplans')"
                        class="form-control @error(" $locale.uncheckeddec") is-invalid @enderror"  id="{{ $locale }}.editor2">
