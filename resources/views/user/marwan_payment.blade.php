...
<div>Card Number: <input type="text" id="card-number" class="form-control input-field" title="card number" aria-label="enter your card number" value="" tabindex="1" readonly></div>
</div>
</div>
<div class="col-lg-6">
<div class="form-group">
...
<div class="col-lg-6">
<div class="form-group">
<div>Security Code:<input type="text" id="security-code" class="form-control input-field" title="security code" aria-label="three digit CCV security code" value="" tabindex="4" readonly></div>
</div>
</div>

<div class="col-lg-6">
<div class="form-group">
<div>Cardholder Name:<input type="text" id="cardholder-name" class="form-control input-field" title="cardholder name" aria-label="enter name on card" value="" tabindex="5" readonly></div>
</div>
</div>
