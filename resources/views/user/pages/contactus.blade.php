        ...
        <div class="row">
            <div class="col-md-6 col-sm-6 order-sm-2">
                <div class="contact-info px-2">
                    ...
                    <p><i class="fas fa-map-marker-alt"></i>@if(setting()->address != null) {!! setting()->address !!} @endif</p>
                    <p><i class="fas fa-phone"></i><a href="tel:01000291432">@if(setting()->phone != null) {{ setting()->phone  }} @endif </a></p>
                    <p><i class="fas fa-envelope"></i><a href="mailto:info@deltaitech.com">@if(setting()->email != null) {{ setting()->email  }} @endif</a></p>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-sm-6">
                <div class="success   text-light my-3 p-2 text-center d-none" style="background-color:rgb(38,129,219)"></div>   
            <div class="getin_form">
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="@lang('admin.general.name')" name="name" >
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" placeholder="@lang('admin.general.email')" name="email" >
                    ...
                    <div class="form-group">
                        <label class="d-none" for=""></label>
                        <input class="form-control" type="text" placeholder="@lang('admin.general.phone')" name="phone" >
                    ...
                    <div class="form-group">
                        <label class="d-none" for=""></label>
                        <input class="form-control" type="text" placeholder="@lang("admin.general.title")" name="subject">
                    ...
                    <div class="form-group">
                        <label class="d-none" for=""></label>
                        <textarea class="form-control" placeholder="@lang("admin.general.body")" rows="5" id="message" name="message"></textarea>
                        <div id="Mmessage" class="err"></div> 

                    </div>
                    </div>
                    <div class="col-md-12 col-sm-12">
                    <button class="contact_btn gradient-btn w-100" type="submit">@lang("admin.general.send")</button>
                    </div>
                </div>
                </form>
            </div>
