...
<head>
    ...
    <title>{{__('user.header.service_request')}}</title><!--[if (mso 16)]>
    <style type="text/css">
        a {
                                                    ...
                                                    <table
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                {{__('custom_validation.service_details')}}
                                                                </h1></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                   {{__('custom_validation.mail_service_request') . $service->name}}</p></td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                style="padding:20px;Margin:0"><h4
                                                                    ...
                                                                    {{__('custom_validation.service_details')}} :</h4></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong> {{__('custom_validation.name')}} : {{$service->name}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.phone')}} : {{$service->phone}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.email')}} : {{$service->email}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.message')}} : {{$service->message}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                </table>
