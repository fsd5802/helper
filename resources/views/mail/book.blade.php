                    ...
                    <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:separate;border-spacing:0px;border-left:1px solid #efefef;border-right:1px solid #efefef;border-top:1px solid #efefef;border-bottom:1px solid #efefef;background-color:#fafafa" width="100%" cellspacing="0" cellpadding="0" bgcolor="#fafafa" role="presentation">
                      ...
                      <tr style="border-collapse:collapse">
                        ...
                        <table style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;border-color:#eee;width:100%" cellspacing="1" cellpadding="1" border="0" align="left" class="cke_show_border" role="presentation">
                          <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px"><strong>Tour name:</strong></td>
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{$book->programe->title}}</td>
                          </tr>
                          <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px"><strong>Tour check in:</strong></td>
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{$book->check_in}}</td>
                          </tr>
                          <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px"><strong>Tour check out:</strong></td>
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{$book->check_out}}</td>
                          </tr>
                          <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px"><strong>Number of adults:</strong></td>
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{$book->adult}}</td>
                          </tr>
                          <tr style="border-collapse:collapse">
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px"><strong>Number of children:</strong></td>
                            <td style="padding:0;Margin:0;font-size:14px;line-height:21px">{{count(json_decode($book->child))}}</td>
                          </tr>
                          {{-- <tr style="border-collapse:collapse">
