                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <h1 style="Margin:0;line-height:36px;mso-line-height-rule:exactly;font-family:'trebuchet ms', helvetica, sans-serif;font-size:30px;font-style:normal;font-weight:normal;color:#333333">
                                                                    {{__('custom_validation.contact_details')}}
                                                                </h1></td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="center"
                                                                ...
                                                                <p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;color:#333333;font-size:14px">
                                                                    {{__('custom_validation.mail_contact_request') . $contact->name}}</p>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                        ...
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                style="padding:20px;Margin:0"><h4
                                                                    ...
                                                                    {{__('custom_validation.contact_details')}} :</h4>
                                                            </td>
                                                        </tr>
                                                        <tr style="border-collapse:collapse">
                                                            <td align="{{(App::isLocale('ar') ? 'right' : 'left')}}"
                                                                ...
                                                                <table
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong> {{__('custom_validation.name')}}
                                                                                : {{$contact->name}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.phone')}}
                                                                                : {{$contact->phone}}</strong>
                                                                        </td>
                                                                    </tr>
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.email')}}
                                                                    ...
                                                                    <tr style="border-collapse:collapse">
                                                                        <td style="padding:0;Margin:0;font-size:14px;line-height:21px">
                                                                            <strong>{{__('custom_validation.message')}}
